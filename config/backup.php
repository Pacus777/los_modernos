...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('BACKUP_NAME', 'WAYNA'),

        'source' => [
            'files' => [
                /*
                 * S3-08: respaldo centrado en BD; archivos públicos opcionales (fotos QR, etc.).
                 */
                'include' => [
     ...
     */
        'notifications' => [
            /*
             * Alertas por Telegram vía App\Listeners (S3-08), no por mail.
             */
            'notifications' => [
